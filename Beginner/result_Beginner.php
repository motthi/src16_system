 ...
 * Time: 16:19
 *
 * https://proengineer.internous.co.jp/content/columnfeature/6190
 */
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="result_Beginner.css">
    <title>Beginner Result</title>
</head>
<body>
...
<div class="img">
    <div class="mask">
        <h1 class="title" class="normal">
            <span>SRC16 Beginner</span> <span>試合結果</span>
        </h1>
        <hr>

        <h2 style="color:red" class="normal">
            <span>全日程が終了しました。</span><span>優勝は"Aya"です！</span>
        </h2>
        ...
        if ($_SESSION["Match"] == 0){
            echo "<h2>";
            echo "<span>予選　結果</span><span>（上位4チームが決勝進出）</span>";
            echo "</h2>";
        }
        ...
        if ($_SESSION["Match"] == 0 ){
            ...
            <div class="dtable">
                <div class="dtable_c">
                    <h2>決勝トーナメント</h2>
                    <table cellpadding="0" cellspacing="0" class="tournament">
                        <tr height="60">
                            <th width="80" rowspan="3"><?php echo $team[0];?><br><p style="font-size:10px;">(Aコート)</p></th><td width="150" valign="bottom"></td>
                        </tr>
                        <tr height="3">
                            <td bgcolor=<?php echo $l1;?>></td><td width="6" rowspan="2" bgcolor=<?php echo $l1;?>>
                        </tr>
                        <tr height="60">
                            <td valign="top"></td><td width="200"><?php echo $score[0];?></td>
                        </tr>
                        <tr height="3">
                            <td></td><td></td><td width="6" bgcolor=<?php echo $l3;?>></td><td width="5" bgcolor=<?php echo $l3;?>><td width="6" rowspan="4" bgcolor=<?php echo $l7;?>></td>
                        </tr>
                        <tr height="60">
                            <th rowspan="3"><?php echo $team[1];?><br><p style="font-size:10px;">(Bコート)</p></th><td valign="bottom"></td><td bgcolor=<?php echo $l2?> rowspan="2"></td><td><?php echo $score[1];?></td><td><?php echo $score[12];?></td>
                        </tr>
                        <tr height="3">
                        ...
                        <tr height="60">
                            <th rowspan="3"><?php echo $team[4];?><br><p style="font-size:10px;">(Aコート)</p></th><td valign="bottom"></td><td width="1"></td><td></td><td rowspan="4" bgcolor=<?php echo $l8;?>></td><td></td>
                        </tr>
                        <tr height="3">
                            <td bgcolor=<?php echo $l4;?>></td><td width="6" rowspan="2" bgcolor=<?php echo $l4;?>><td></td><td></td>
                        </tr>
                        <tr height="60">
                            <td valign="top"></td><td><p class="withTime"><?php echo $score[4];?>(10.79 s)</p></td><td><?php echo $score[13];?></td>
                        </tr>
                        <tr height="3">
                            <td></td><td></td><td bgcolor=<?php echo $l6;?>></td><td bgcolor=<?php echo $l6;?>></td>
                        </tr>
                        <tr height="60">
                            <th rowspan="3"><?php echo $team[5];?><br><p style="font-size: 10px">(Bコート)</p></th><td valign="bottom"></td><td bgcolor=<?php echo $l5;?>></td><td><p class="withTime"><?php echo $score[5];?>(13.06 s)</p></td>
                        </tr>
                        <tr height="3">
                ...
                <div class="dtable_c">
                    ...
                    <table cellpadding="0" cellspacing="0" class="tournament">
                        <tr height="40">
                            <th width="80" rowspan="3"><?php echo $team[8];?><br><p style="font-size:10px;">(Aコート)</p></th><td width="60" valign="bottom"></td>
                        </tr>
                        <tr height="3">
                            <td width="120" bgcolor=<?php echo $l10;?>></td><td width="5" rowspan="2" bgcolor=<?php echo $l10;?>>
                        </tr>
                        <tr height="60">
                            <td valign="top"></td><td width="100"><?php echo $score[8];?></td><td width="150" rowspan="3" align="center"><?php echo $trd;?></td>
                        </tr>
                        <tr height="3">
                            <td></td><td></td><td width="5" bgcolor=<?php echo $l12;?>></td><td width="5" bgcolor=<?php echo $l12;?>>
                        </tr>
                        <tr height="60">
                            <th rowspan="3"><?php echo $team[9];?><br><p style="font-size:10px;">(Bコート)</p></th><td valign="bottom"></td><td bgcolor=<?php echo $l11;?> rowspan="2"></td><td><?php echo $score[9];?></td>
                        </tr>
                        <tr height="3">
                            <td bgcolor=<?php echo $l11?>></td><td></td><td></td>
                        </tr>
                        <tr height="60">
